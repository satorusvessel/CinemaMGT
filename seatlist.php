...
<div class="container-fluid" >
	<div class="row">
		<div class="col-md-12">
			<a class="btn btn-block btn-sm btn-primary col-sm-2"  id="new_movie" href="addseatform.php"> Add New seat</a>
		</div>
	</div>
	<div class="row"  >
			...
			<div class="card-body" style="background-color:black">
				<table class="table table-bordered"  style="background-color:#0865bd">
					...
					<tbody>
						<?php
						$i = 1;
						$movie = $con->query("SELECT * FROM seat ");
						while($row=$movie->fetch_assoc()){
						 ?>
						 <tr>
						 	<td><?php echo $i++ ?></td>
						 	
						 	<td><?php echo ucwords($row['seat_type']) ?></td>
						 	...
						 	<td>
						 		<center>
								<a class="btn btn-warning" href="updatetheatre.php?ID=<?php echo $row["ID"];?>"> Edit </a>
