...
<div class="container-fluid" >
	<div class="row">
		<div class="col-md-12">
			<a class="btn btn-block btn-sm btn-primary col-sm-2"  id="new_movie" href="addmovieform.php"> Add New Movie</a>
		</div>
	</div>
	<div class="row"  >
			...
			<div class="card-body" style="background-color:black">
				<table class="table table-bordered"  style="background-color:#0865bd">
					...
					<tbody>
						<?php
						$i = 1;
						$movie = $con->query("SELECT * FROM movie_table ");
						while($row=$movie->fetch_assoc()){
						 ...
						 <tr>
						 	...
						 	<td> <?php echo $row['length_'] ?> </td>
							 <td> <?php echo $row['show_time'] ?> AM</td>
