...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href="hostyle.css">
...
<div class="movie-list-container" style="   display : flex
   ...
   flex-flow : wrap>">
    <div style="display: flex;flex-direction: row; margin: 4px;padding: 10px;">
...
while($row=mysqli_fetch_array($rsu)){
    ...
    ?>
         ...
         <div class="movie-list-item" style="   display : flex
